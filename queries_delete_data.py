...
def delete_data(session):
    while True:
        ...
        print("1. Видалити студента")
        print("2. Видалити курс")
        print("3. Видалити інструктора")
        print("4. Видалити запис про зарахування")
        print("5. Видалити огляд")
        print("6. Повернутися до меню")
